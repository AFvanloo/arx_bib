...
class Interface(Frame):
    ...
    def initUI(self):
        ...
        self.urlentry = Entry(self, width=100)
        ...
        self.bibentry = Entry(self, width=100)
        ...
        self.titleentry = Entry(self, width=100)
        self.titleentry.grid(row=3, column=2, sticky=W)
        
        self.authorsentry = Entry(self, width=100)
        self.authorsentry.grid(row=4, column=2, sticky=W)
        
        self.journalentry = Entry(self, width=100)
        self.journalentry.grid(row=5, column=2, sticky=W)
        
        self.yearentry = Entry(self, width=100)
        self.yearentry.grid(row=6, column=2, sticky=W)
         
        self.bibtexkeyentry = Entry(self, width=100)
